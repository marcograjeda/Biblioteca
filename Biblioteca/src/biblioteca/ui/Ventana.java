...
import biblioteca.controllers.AutorManager;
import biblioteca.controllers.BookManager;
import biblioteca.controllers.EditorialManager;
import biblioteca.controllers.PrestamoManager;
import biblioteca.controllers.UserManager;
...
public class Ventana {
    ...
    public static void ventana(Stage primaryStage, int valorDelRango) {
        ...
        /*-----------Variables-------------*/
        String modulo = "usuario"; //usuario, libro, propiedad, prestamo
        ...
        ComboBox txtAutor = new ComboBox(FXCollections.observableArrayList(AutorManager.getInstancia().getListaNombreAutor())); //Libro
        ComboBox txtEditorial = new ComboBox(FXCollections.observableArrayList(EditorialManager.getInstancia().getListaNombreEditorial())); //Libro
        TextField txtPrecio = new TextField(); //Libro
        TextField txtIsbn = new TextField(); //Libro
        ComboBox txtLibroPrestado = new ComboBox(FXCollections.observableArrayList(BookManager.getInstancia().getListaNombreLibro())); //Prestamo
        ...
        olAutor = FXCollections.observableArrayList(AutorManager.getInstancia().getListaAutor());
        olEditorial = FXCollections.observableArrayList(EditorialManager.getInstancia().getListaEditorial());
        olLibro = FXCollections.observableArrayList(BookManager.getInstancia().getListaLibro());
        olPrestamo = FXCollections.observableArrayList(PrestamoManager.getInstancia().getListaPrestamo());
            ...
            public void handle(ActionEvent e) {
                if (title.getText().equals("Usuario")) {    
                    if (Ventana.verificadorTextoNumero(txtSearch.getText())) {
                        olUsuario = FXCollections.observableArrayList(UserManager.getInstancia().getListaIdUsuario(txtSearch.getText()));
                        ...
                        olUsuario = FXCollections.observableArrayList(UserManager.getInstancia().getListaNombreUsuario(txtSearch.getText()));
                        resultadosUsuario.getItems().clear();
                        resultadosUsuario.setItems(olUsuario);
                        caja2.getChildren().clear();
                        caja2.getChildren().add(title);
                    ...
                    if (Ventana.verificadorTextoNumero(txtSearch.getText())) {
                        olAutor = FXCollections.observableArrayList(AutorManager.getInstancia().getListaIdAutor(txtSearch.getText()));
                        ...
                        olAutor = FXCollections.observableArrayList(AutorManager.getInstancia().getListaNombreAutor(txtSearch.getText()));
                        resultadosAutor.getItems().clear();
                        resultadosAutor.setItems(olAutor);
                        caja2.getChildren().clear();
                        caja2.getChildren().add(title);
                    ...
                    if (Ventana.verificadorTextoNumero(txtSearch.getText())) {
                        olEditorial = FXCollections.observableArrayList(EditorialManager.getInstancia().getListaIdEditorial(txtSearch.getText()));
                        ...
                        olEditorial = FXCollections.observableArrayList(EditorialManager.getInstancia().getListaNombreEditorial(txtSearch.getText()));
                        resultadosEditorial.getItems().clear();
                        resultadosEditorial.setItems(olEditorial);
                        caja2.getChildren().clear();
                        caja2.getChildren().add(title);
                    ...
                    if (Ventana.verificadorTextoNumero(txtSearch.getText())) {
                        olLibro = FXCollections.observableArrayList(BookManager.getInstancia().getListaIdLibro(txtSearch.getText()));
                        ...
                        olLibro = FXCollections.observableArrayList(BookManager.getInstancia().getListaNombreLibro(txtSearch.getText()));
                        resultadosLibro.getItems().clear();
                        resultadosLibro.setItems(olLibro);
                        caja2.getChildren().clear();
                        caja2.getChildren().add(title);
                    ...
                    if (Ventana.verificadorTextoNumero(txtSearch.getText())) {
                        olPrestamo = FXCollections.observableArrayList(PrestamoManager.getInstancia().getListaIdPrestamo(txtSearch.getText()));
                        ...
                        olPrestamo = FXCollections.observableArrayList(PrestamoManager.getInstancia().getListaNombrePrestamo(txtSearch.getText()));
                        resultadosPrestamo.getItems().clear();
                        resultadosPrestamo.setItems(olPrestamo);
                        caja2.getChildren().clear();
                        caja2.getChildren().add(title);
            ...
            public void handle(ActionEvent e) {
                if (title.getText().equals("Usuario")) {
                    ...
                    olUsuario = FXCollections.observableArrayList(UserManager.getInstancia().getListaUsuario());
                        ...
                        if(accion.getText().equals("Agregar")) {
                            int numero = EditorialManager.getInstancia().getListaEditorial().size() + 1;
                            Editorial agregarUserBD = new Editorial(numero, txtNombre.getText());
                            EditorialManager.getInstancia().agregarEditorial(agregarUserBD);
                        } else if(accion.getText().equals("Modificar")) {
                            int numero = resultadosEditorial.getSelectionModel().getSelectedItem().getIdEditorial();
                            EditorialManager.getInstancia().editarEditorial(numero, txtNombre.getText());
                        ...
                        if(accion.getText().equals("Agregar")) {
                            int numero = AutorManager.getInstancia().getListaAutor().size() + 1;
                            Autor agregarUserBD = new Autor(numero, txtNombre.getText());
                            AutorManager.getInstancia().agregarAutor(agregarUserBD);
                        } else if(accion.getText().equals("Modificar")) {
                            int numero = resultadosAutor.getSelectionModel().getSelectedItem().getIdAutor();
                            AutorManager.getInstancia().editarAutor(numero, txtNombre.getText());
                        }
                        olAutor = FXCollections.observableArrayList(AutorManager.getInstancia().getListaAutor());
                        resultadosAutor.getItems().clear();
                        resultadosAutor.setItems(olAutor);
                        ...
                        if(accion.getText().equals("Agregar")) {
                            int numero = BookManager.getInstancia().getListaLibro().size() + 1;
                            ...
                            BookManager.getInstancia().agregarLibro(agregarUserBD);
                        } else if(accion.getText().equals("Modificar")) {
                            int numero = resultadosLibro.getSelectionModel().getSelectedItem().getIdLibro();
                            BookManager.getInstancia().editarLibro(numero, txtNombre.getText(), txtEditorial.getPromptText(), txtIsbn.getText(), Integer.parseInt(txtPrecio.getText()));
                        ...
                        if(accion.getText().equals("Agregar")) {
                            ...
                            int numero = PrestamoManager.getInstancia().getListaPrestamo().size() + 1;
                            Prestamo agregarUserBD = new Prestamo(0, txtLibroPrestado.getPromptText(), sdf.format(new Date()), txtDevolucion.getText(), true);
                            PrestamoManager.getInstancia().agregarPrestamo(agregarUserBD);
                        } else if(accion.getText().equals("Devolver")) {
                            int numero = resultadosPrestamo.getSelectionModel().getSelectedItem().getIdPrestamo();
                            int numero1 = BookManager.getInstancia().devolverIdLibro(resultadosPrestamo.getSelectionModel().getSelectedItem().getIdLibro());
                            PrestamoManager.getInstancia().devolverPrestamo(numero, numero1);
                        }
                    olPrestamo = FXCollections.observableArrayList(PrestamoManager.getInstancia().getListaPrestamo());
                        resultadosPrestamo.getItems().clear();
                        resultadosPrestamo.setItems(olPrestamo);
        ...
        btnBorrar.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                if (title.getText().equals("Usuario") && resultadosUsuario.getSelectionModel().getSelectedItem() != null) {
                        int numero = resultadosUsuario.getSelectionModel().getSelectedItem().getIdUsuario();
                        UserManager.getInstancia().eliminarUsuario(numero);
                        olUsuario = FXCollections.observableArrayList(UserManager.getInstancia().getListaUsuario());
                        resultadosUsuario.getItems().clear();
                        resultadosUsuario.setItems(olUsuario);
                        caja2.getChildren().clear();
                        ...
                        int numero = resultadosEditorial.getSelectionModel().getSelectedItem().getIdEditorial();
                        EditorialManager.getInstancia().eliminarEditorial(numero);   
                        olEditorial = FXCollections.observableArrayList(EditorialManager.getInstancia().getListaEditorial());
                            resultadosEditorial.getItems().clear();
                            resultadosEditorial.setItems(olEditorial);
                            caja2.getChildren().clear();
                        ...
                        int numero = resultadosAutor.getSelectionModel().getSelectedItem().getIdAutor();
                        AutorManager.getInstancia().eliminarAutor(numero);
                        olAutor = FXCollections.observableArrayList(AutorManager.getInstancia().getListaAutor());
                        resultadosAutor.getItems().clear();
                        resultadosAutor.setItems(olAutor);
                        caja2.getChildren().clear();
                        ...
                        int numero = resultadosLibro.getSelectionModel().getSelectedItem().getIdLibro();
                        BookManager.getInstancia().eliminarLibro(numero);
                            resultadosLibro.getItems().clear();
                            resultadosLibro.setItems(olLibro);
                            caja2.getChildren().clear();
                            caja2.getChildren().add(title);
                        ...
                        //int numero = resultadosLibro.getSelectionModel().getSelectedItem().getIdLibro();
                        //PrestamoManager.getInstancia().eliminarPrestamo(numero);   
                        olPrestamo = FXCollections.observableArrayList(PrestamoManager.getInstancia().getListaPrestamo());
                        resultadosPrestamo.getItems().clear();
                        resultadosPrestamo.setItems(olPrestamo);
                        caja2.getChildren().clear();
